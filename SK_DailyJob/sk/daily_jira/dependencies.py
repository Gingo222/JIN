...
class Config:
    ...
    JIRA_AUTH_DATA: str = None
    STORY_CSV_FILE: str = None
    EFFICIENCY_CSV_FILE: str = None
    PROJECT: str = '冠脉智能诊断'
    BROAD: str = '冠脉研发'
    SPRINT: str = None
...
def bind_config(binder):
    ...
    if not config_filename:
        config_filename = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'daily_jira', 'configs', 'jira.yml')
